...
export const getActiveNode = async (networkType?: number) => {
  const network = networkType ?? sym.NetworkType.TEST_NET;
...
const getNode = async (network: number): Promise<string> => {
